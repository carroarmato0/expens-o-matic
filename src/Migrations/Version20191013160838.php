...
final class Version20191013160838 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE expense (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, submit_date DATETIME NOT NULL, date DATE NOT NULL, name VARCHAR(60) NOT NULL, description VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, approved SMALLINT DEFAULT 0 NOT NULL, reimbursed SMALLINT DEFAULT 0 NOT NULL, INDEX IDX_2D3A8DA69D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
